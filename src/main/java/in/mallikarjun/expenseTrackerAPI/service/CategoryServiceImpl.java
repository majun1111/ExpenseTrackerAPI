...
import in.mallikarjun.expenseTrackerAPI.dto.UserDTO;
import in.mallikarjun.expenseTrackerAPI.entity.CategoryEntity;
...
import in.mallikarjun.expenseTrackerAPI.repository.CategoryRepository;
...
public class CategoryServiceImpl implements CategoryService{
    ...
    public CategoryDTO saveCategory(CategoryDTO categoryDTO) {
        ...
        if (isCategoryPresent) {
            throw new ItemAlreadyExistException("Category is already present for the name "+categoryDTO.getName());
        }
